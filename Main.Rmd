...
```
What does NULL signify in Open or URL - Just using it as a not opened at all
```{r}
...
```{r}
message2 <- setNames(message2, c("identity", "sum_open_or_url"))
message3 <- setNames(message3, c("identity", "sum_num_of_messages"))
```
